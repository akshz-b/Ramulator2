...
class GenericDRAMController final : public IDRAMController, public Implementation {
  ...
  public:
    ...
    void setup(IFrontEnd* frontend, IMemorySystem* memory_system) override {
      ...
      cout<<" Total cores used = "<<m_num_cores<<endl;
    ...
    bool send(Request& req) override {
    	// std::cout<<" In send method "<<std::endl;

      // cout<<endl;

      // cout<<" Request Address: " << req.addr;
      ...
      // cout<<", Type ID: " << req.type_id;
      // cout<< ", Source ID: " << req.source_id;
      ...
      if (request_found) {
        ...
        if (req_it->command == req_it->final_command) {
          if (req_it->type_id == Request::Type::Read) {
            ...
            // cout<<"\n Req Adress: " << req_it->addr;
            // cout<< ", Depart: " << req_it->depart;
    ...
    void serve_completed_reads() {
      if (pending.size()) {
        ...
        if (req.depart <= m_clk) {
          ...
          //  cout<<"Req Adress: " << req.addr;
          //  cout<< ", Depart: " << req.depart;
          pending.pop_front();

          // std::cout << "\nCompleting request " <<std::endl;
